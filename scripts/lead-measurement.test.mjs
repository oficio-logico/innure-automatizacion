...
function setup({ consent, origin = 'https://www.innure.es', destination = 'AW-123456/AutomationOnly', search = '', pathname = '/', cookies = [] } = {}) {
  const local = new Map(); const session = new Map(); const events = new Map(); const documentEvents = new Map(); const tags = []; const buttons = new Map(); const cookieWrites = []; let banner; let reloads = 0;
