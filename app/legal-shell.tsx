...
export function LegalShell({ title, children }: { title: string; children: ReactNode }) {
  return <div className="legal-page">
    <header className="legal-header"><div className="shell header-inner">
      <a className="wordmark" href={withBasePath('/')}><span>innure</span><small>Automatización e IA</small></a>
      <a className="legal-back" href={withBasePath('/')}>← Volver a la página principal</a>
    </div></header>
    <main>
      <section className="legal-hero shell"><h1>{title}</h1><p>Última actualización: 8 de septiembre de 2026.</p></section>
      <div className="legal-content shell"><aside className="legal-toc"><strong>Innure · Automatización e IA</strong>
